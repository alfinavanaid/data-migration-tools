...
class TableIgnored implements CustomTableField
{
    ...
    private $object_json;
    private const KEYNAME = 'table_ignored';
    ...
    /**
     * Check if table exist on this ignoration lists
     * @param String reference_table_name 
     * @param String column_name 
     * @return bool
     */

    public function check(String $reference_table_name): bool
    {
        $this->setValue();
        return in_array($reference_table_name,  $this->getValue());
    }
}
